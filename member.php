...
<nav class="navbar navbar-expand-lg bg-success navbar-dark fixed-top">
  ...
  <tr class="table-info">
    ...
    <a href="edit.php?NIK=<?php echo $d['NIK']; ?>" style="color: white; font-weight: bold; text-decoration: none;">EDIT</a>
</button>

<button type="button" class="btn btn-danger">
    <a href="hapus.php?NIK=<?php echo $d['NIK']; ?>" style="color: white; font-weight: bold; text-decoration: none;">HAPUS</a>
</button>
