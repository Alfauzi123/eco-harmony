...
<nav class="navbar navbar-expand-lg bg-success navbar-dark fixed-top">
  ...
  <a class="btn btn-primary" href="tambah_hasil.php">TAMBAH DATA </a>
	<br/>
  <a class="btn btn-info" target="_blank" href="cetak.php">PRINT</a>
	<br/>
	<table class="table">
  ...
  <tr class="table-info">
      ...
      <th>-EDIT-</th>
        ...
        <a class="btn btn-success" href="edit_HASIL_KEG.php?ID_Kegiatan=<?php echo $d['ID_Kegiatan']; ?>">EDIT</a>
        <br>
        <a class="btn btn-danger" href="hapus_HASIL_KEG.php?ID_Kegiatan=<?php echo $d['ID_Kegiatan']; ?>" onclick="return confirm('Apakah Anda ingin menghapus data ini?');">HAPUS</a>
        <br>
        <a class="btn btn-warning" href="detail_kehadiran.php?ID_Kegiatan=<?php echo $d['ID_Kegiatan']; ?>">DETAIL KEHADIRAN</a>
